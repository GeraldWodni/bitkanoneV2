...
\ (c)copyright 2014, 2016, 2018 by Gerald Wodni <gerald.wodni@gmail.com>

\ colors are represented as word (i.e $112233), this format is called rgb
\ byte wise colors are alled crgb

compiletoflash

\ decay all pixels per 1/colorchannel
: decay-color ( -- )
